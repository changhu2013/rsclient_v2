...
public abstract class Parser {
	...
	public Object marshal(Object bean, Class<?> clazz) throws ParserException {
		...
		if (clazz.isPrimitive()) {
			...
			return marshalToMap(bean);
		} else if (List.class.isAssignableFrom(clazz)) {
			return marshalToList(bean);
		} else {
			return marshalToObj(bean, clazz);
		}
	}

	public abstract Object marshalToMap(Object bean) throws ParserException;

	public abstract Object marshalToList(Object bean) throws ParserException;

	public abstract Object marshalToObj(Object bean, Class<?> clazz)
			throws ParserException;

	protected boolean isWrapperPrimitiveClass(Class<?> clazz) {
	...
	protected Object castPrimitive(Object bean, Class<?> clazz) {
	 ...
	 * @return
	 */
	protected Object castWrapperPrimitive(Object bean, Class<?> clazz) {
